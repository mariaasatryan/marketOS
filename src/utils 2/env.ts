...
export function validateEnvironment(): EnvConfig {
  ...
  if ((import.meta as any).env.VITE_SUPABASE_URL) {
    config.VITE_SUPABASE_URL = (import.meta as any).env.VITE_SUPABASE_URL;
  }
  if ((import.meta as any).env.VITE_SUPABASE_ANON_KEY) {
    config.VITE_SUPABASE_ANON_KEY = (import.meta as any).env.VITE_SUPABASE_ANON_KEY;
  }
  if ((import.meta as any).env.VITE_APP_MODE) {
    config.VITE_APP_MODE = (import.meta as any).env.VITE_APP_MODE as 'MOCK' | 'LIVE';
  }
  if ((import.meta as any).env.VITE_GOOGLE_OAUTH_CLIENT_ID) {
    config.VITE_GOOGLE_OAUTH_CLIENT_ID = (import.meta as any).env.VITE_GOOGLE_OAUTH_CLIENT_ID as string;
  }
  if ((import.meta as any).env.VITE_GOOGLE_REDIRECT_URI) {
    config.VITE_GOOGLE_REDIRECT_URI = (import.meta as any).env.VITE_GOOGLE_REDIRECT_URI as string;
  }
